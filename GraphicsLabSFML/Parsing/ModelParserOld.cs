...
{
    public class ModelParserOld : IModelParserOld
    {
        public ModelOld Parse(IEnumerable<string> source)
        {
            var faces = new List<FaceOld>();
